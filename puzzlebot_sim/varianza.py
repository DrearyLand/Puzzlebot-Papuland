...
# Aquí van las mediciones de las pruebas físicas
# Ejemplo: si avanzó 1m, y midieron 0.97, 0.99, 1.02 etc
...
print("-> Este valor para afinar kr o kl en localisation_node.py")